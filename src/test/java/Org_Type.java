 ...
 * @generated */
public class Org_Type extends Annotation_Type {
  /** @generated 
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("Org");
  ...
  public String getExpandedForm(int addr) {
      ...
      jcas.throwFeatMissing("expandedForm", "Org");
